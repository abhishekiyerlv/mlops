...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-2376768479807879.19.azuredatabricks.net/explore/data/models/staging/mlops/mlops-model)
* [Prod model in UC](https://adb-2376768479807879.19.azuredatabricks.net/explore/data/models/prod/mlops/mlops-model)
. 
